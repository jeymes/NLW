        ...
        <Dialog.Portal>
            ...
            <Dialog.Overlay className="bg-black/60 inset-0 fixed">
                ...
                <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2
                    ...
                    <form onSubmit={handleCreateAd} className="mt-4 flex flex-col gap-1">
                        <div className="flex flex-col gap-2">
                            ...
                            defaultValue="" 
                            name="game"
                            className='appearance-none bg-zinc-900 py-3 px-4 rounded text-sn placeholder:text-zinc-500'>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Input name="name" id="nome" placeholder="Como te chamam dentro do game?"/>
                        </div>
                        ...
                        <label className="mt-2 flex gap-2 items-center gap text-sm">
                            <Checkbox.Root
                        ...
                        <footer className="mt-4 flex justify-end gap-4 ">
                            ...
                            <button className="items-center gap-3 bg-violet-500 px-5 h-12 rounded-md flex font-semibold hover:bg-violet-600" type="submit">
